...
public class ServerEnvironmentDetector {
    ...
    public static EnvironmentInfo detectEnvironment() {
        ...
        if (isPterodactyl()) {
            ...
            logger.info("Detected environment: Pterodactyl Panel");
        ...
        if (isDocker()) {
            ...
            logger.info("Detected environment: Docker Container");
        ...
        if (isSharedHosting()) {
            ...
            logger.info("Detected environment: Shared Hosting");
        ...
        logger.info("Detected environment: VPS/Dedicated Server");
